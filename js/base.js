...
var timer = setInterval(function () {
    ...
    $('#date').html('<span>' + year + '/' + (month + 1) + '/' + data + '</span><span>' + ampm + '</span><span>周' + arr[day] + '</span>')
...
var option = {
     ...
     axisLabel: {
        ...
        series: [{
            name: '条数',
            type: 'line',
            data: [8000, 3000, 5000, 7000, 3000, 6000],
    ...
    series : [
        {
            ...
            type:'bar',
            barWidth: '60%',
            data:[800, 720, 600, 619, 390, 500, 520]
        }
    ]
};
